...
class TopologyServiceComponent
{
    ...
    public static function getRankwisePath($jsonRequestData, $strUniqueId = '')
    {
        ...
        OrchestratorComponent::saveApiLogs($strUniqueId, yii::$app->params['topologyServiceUrl'], $jsonRequestData, $rankwisePath);
        ...
        OrchestratorComponent::saveApiLogs($strUniqueId, yii::$app->params['topologyServiceUrl'] ,$arrRequest['data'] , $arrResponse);
        return $arrResponse['result'][0]; */
    }
