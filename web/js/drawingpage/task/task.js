...
var isXChecked = true, isYChecked = true;
...
var drag = d3.behavior.drag()
    ...
    .on("dragstart", function () { 
        ...
        if (bpmnobject.start_id === elementid &&  bpmnobject.id != 0) {
            console.log(" inside start"+ bpmnobject.start_id +' ==>> '+ elementid +' ==>>> '+ bpmnobject.id)
            dragFlows.push({
                "id": bpmnobject.id,
...
if (subElement === "UserTask") {
    var dragtext = group.append('foreignObject')
        ...
        .html("<div id=\"textidtask"+idtaskelement+"\"; style=\"width: 80%; height:45px ; background-color: transparent;\" ></div>");
    ...
    var dragtext = group.append('foreignObject')
                        ...
                        .attr('height', 50)
                        .append("xhtml:body")
                        .html("<div id=\"textidtask"+idtaskelement+"\"; style=\"width: 70px; height:45px ; background-color: transparent;\" ></div>");
    ...
    var dragbarbottom = newg.append("rect")
      ...
      function dragmove(d) {
        ...
        if (isXChecked) {
            ...
            //dragtext.attr("width", width);//foreignobject
            d3.select("fobject1").style("width", height)
