        ...
        group.append('circle')
         ...
         //   .attr('transform', 'translate(' + d3.event.pageX + ',' + d3.event.pageY + ')')
            ...
            .on("mouseup", function () {
                ...
                // console.log("CircleWidth : "+ CircleWidth + "CircleHeight : "+ CircleHeight)
            ...
            .on("click", function () {
                ...
                // console.log( ' For Flow 2 '+ window.bpmnElement);
                ...
                // groupSelect.select('rect').remove();
                // var CircleWidth = this.getBoundingClientRect().width;
                // var CircleHeight = this.getBoundingClientRect().height;

                // groupSelect.append("rect")
                //             .attr("x", function(d) { return (coords.x - (CircleWidth/2)); })
                //             .attr("y", function(d) { return (coords.y- (CircleHeight/2)); })
                //             .attr("cursor", "move")
                //             // .style("stroke", "black")
